          ...
          <div className="flex-1 h-screen flex flex-col justify-center items-center bg-white">
            <Card className="w-126.25 px-6 shadow-none border-none rounded-none ring-0 item-center flex flex-col">
              ...
              <CardContent className="w-full flex flex-col gap-6">
                ...
                <div>
                  <div
                    className={`flex items-center bg-white border ${usernameStatus === "taken" ? "border-red-500" : usernameStatus === "available" ? "border-green-500" : "border-gray-100"} shadow-[0_4px_12px_rgba(0,0,0,0.08)] relative overflow-hidden h-14 pl-3 pr-4 transition-colors`}
                  >
                    <div className="absolute left-0 top-0 bottom-0 w-2 bg-[#FF5700] rounded-r-xl" />
                    <span
                      className={`material-symbols-outlined px-3 ${usernameStatus === "taken" ? "text-red-500" : usernameStatus === "available" ? "text-green-500" : "text-gray-500"} transition-colors`}
                    >
                      id_card
                    </span>
                    <div className="h-6 w-px bg-gray-300 mr-3" />
                  ...
                  {usernameStatus === "taken" && (
                    <p className="text-red-500 text-xs mt-1 ml-1 font-['Poppins']">
                      Username already exists.
                    </p>
                  )}
                  {usernameStatus === "available" && (
                    <p className="text-green-500 text-xs mt-1 ml-1 font-['Poppins']">
                ...
                <div>
                  <div
                    className={`flex items-center bg-white border ${emailStatus === "taken" || emailStatus === "invalid" ? "border-red-500" : emailStatus === "available" ? "border-green-500" : "border-gray-100"} shadow-[0_4px_12px_rgba(0,0,0,0.08)] relative overflow-hidden h-14 pl-3 pr-4 transition-colors`}
                  >
                    <div className="absolute left-0 top-0 bottom-0 w-2 bg-[#FF5700] rounded-r-xl" />
                    <span
                      className={`material-symbols-outlined px-3 ${emailStatus === "taken" || emailStatus === "invalid" ? "text-red-500" : emailStatus === "available" ? "text-green-500" : "text-gray-500"} transition-colors`}
                    >
                      mail
                    </span>
                    <div className="h-6 w-px bg-gray-300 mr-3" />
                ...
                <div>
                  <div
                    className={`flex items-center bg-white border ${registerConfirmPassword.length > 0 ? (registerPassword === registerConfirmPassword ? "border-green-500" : "border-red-500") : "border-gray-100"} shadow-[0_4px_12px_rgba(0,0,0,0.08)] relative overflow-hidden h-14 pl-3 pr-4 transition-colors`}
                  >
                    <div className="absolute left-0 top-0 bottom-0 w-2 bg-[#FF5700] rounded-r-xl" />
                    <span
                      className={`material-symbols-outlined px-3 ${registerConfirmPassword.length > 0 ? (registerPassword === registerConfirmPassword ? "text-green-500" : "text-red-500") : "text-gray-500"} transition-colors`}
                    >
                      key
                    </span>
                    <div className="h-6 w-px bg-gray-300 mr-3" />
